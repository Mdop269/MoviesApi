...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ActFname, e.ActLname, e.ActGender }, "check_Unique_ActorName").IsUnique();
        ...
        modelBuilder.Entity<Director>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DirFname, e.DirLname }, "check_Unique_Directorname").IsUnique();
        ...
        modelBuilder.Entity<Genre>(entity =>
        {
            ...
            entity.HasIndex(e => e.GenTitle, "check_Unique_genres").IsUnique();
        ...
        modelBuilder.Entity<Movie>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.MovTitle, e.MovYear, e.MovTime, e.MovLang, e.MovRlDt, e.MovRelCountry }, "checkUniqueMovieName").IsUnique();
        ...
        modelBuilder.Entity<MovieCast>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.MovId, e.ActId }, "checkUniqueMovieCast").IsUnique();
        ...
        modelBuilder.Entity<MovieDirection>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.MovId, e.DirId }, "checkUniqueMovieDirection").IsUnique();
        ...
        modelBuilder.Entity<MovieGenre>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.MovId, e.GenId }, "checkUniqueMovieGenres").IsUnique();
        ...
        modelBuilder.Entity<Rating>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.MovId, e.RevId }, "checkUniqueRating").IsUnique();
